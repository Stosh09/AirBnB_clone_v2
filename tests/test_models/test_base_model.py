...
class test_basemodel(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        """ Initializing a BaseModel class used in the tests """
    ...
    def test_default(self):
        """default testing for the base class """

        i = self.value()
        self.assertEqual(type(i), self.value)

    def test_kwargs(self):
        """ testing instance creation from kwargs dictionary """
    ...
    def test_todict(self):
        """ testing the to_dict method of class """
